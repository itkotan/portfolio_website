...
export const EdgingGit: FC = () => {
  return (
    <div className='w-[80%] h-[20%] m-auto flex flex-col justify-end'>
      ...
      {/* <div className='w-full h-[100%] text-center bg-[#787BFE] rounded-lg m-auto  git_info_container'>
        <div className='relative h-[30%] w-full flex items-center flex-col'>
          <div className='w-[5rem] border-[0.5rem] border-[#787BFE]  absolute top-[-1rem] rounded-full git_info_container'>
            <img className='w-full rounded-full' src={iGit} />
          </div>
        </div>
        <div className='h-[70%]'>
          <div className='text-white text-lg  mt-5'>Magomed M</div>
          <div className='text-[#5355c4] text-sm mt-1'>
